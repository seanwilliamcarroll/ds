...
REGISTER_PATTERN(BM_FindMissWarm, KeyPattern::SEQUENTIAL);
REGISTER_PATTERN(BM_FindMissWarm, KeyPattern::UNIFORM);
REGISTER_PATTERN(BM_FindMissWarm, KeyPattern::NORMAL);
